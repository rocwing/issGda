...
public class NonCimQueueReceive implements MessageListener{
	...
	public final static String QUEUE="pms-bdpt-fei-queue";
	...
	*/
	...
	NonCimQueueReceive qr = new NonCimQueueReceive();
	qr.init(ic, QUEUE);
