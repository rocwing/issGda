<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cim="http://iec.ch/TC57/2003/CIM-schema-cim10#" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
  ...
  <xsl:template match="/rdf:RDF">
    <EQUIP>
      ...
      <MAPPING_URI>
        '<xsl:value-of
        select="substring(cim:ProtectionEquipment/cim:PowerSystemResource.Asset/@rdf:resource,12,17)"/>'
      </MAPPING_URI>
      <EQUIPMENT_CONTAINER>
        '<xsl:value-of
        select="substring(cim:ProtectionEquipment/cim:Equipment.MemberOf_EquipmentContainer/@rdf:resource,17,17)"/>'
      </EQUIPMENT_CONTAINER>
      <ITEM>
        <Property name="PSRTYPE">
          '<xsl:value-of
          select="substring(cim:ProtectionEquipment/cim:PowerSystemResource.PSRType/@rdf:resource,14,9)"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="ORG_NAME">
          '<xsl:value-of
          select="substring-after(cim:ProtectionEquipment/cim:PowerSystemResource.Organisations/@rdf:resource,'@')"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="ALIASNAME">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:Naming.aliasName"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="DISPATCHNO">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:PowerSystemResource.dispatchNo"/>'
        </Property>
      </ITEM>
      <ITEM>
      ...
      <ITEM>
        <Property name="NAME">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:Naming.name"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="MODEL">
      ...
      <ITEM>
        <Property name="EQUIPMENTTYPE">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.equipmentType"/>'
        </Property>
      </ITEM>
      ...
      <ITEM>
        <Property name="MAINTAINORGANISATION">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.maintainOrganisation"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="GOODSSOURCE">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.goodsSource"/>'
        </Property>
      </ITEM>
      <xsl:for-each select="cim:Property">
      ...
      <ITEM>
        <Property name="OVERHAULCYCLE">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.overhaulCycle"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="STATIONTYPE">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.stationType"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="PARENTID">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.parentId"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="PARENTNAME">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.parentName"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="PARSYSTEM">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:ProtectionEquipment.parSystem"/>'
        </Property>
      </ITEM>
      <ITEM>
        <Property name="REMARKS">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:PowerSystemResource.remarks"/>'
        </Property>
      </ITEM>
      <xsl:for-each select="cim:Property">
      ...
      <ITEM>
        <Property name="LASTOVERHAULDATE">
          '<xsl:value-of
          select="cim:ProtectionEquipment/cim:PowerSystemResource.lastOverhaulDate"/>'
        </Property>
      </ITEM>
      <xsl:for-each select="cim:Property">
